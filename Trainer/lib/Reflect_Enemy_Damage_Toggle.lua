...
local unit_table = {"spooc","taser","cloaker","shield","tank","tank_mini","tank_medic","tank_hw","piggydozer","sniper","gangster","cop","cop_female","security","medic","gensec","swat","heavy_swat","zeal_heavy_swat","fbi","fbi_swat","fbi_heavy_swat","marshal_marksman","marshal_shield","city_swat","mobster_boss","mobster","hector_boss","hector_boss_no_armor","biker_boss","chavez_boss","biker","bolivian","bolivian_indoors_mex","bolivians","phalanx_vip","phalanx_minion","shadow_spooc","drug_lord_boss","drug_lord_boss_stealth","drunk_pilot","spa_vip","spa_vip_hurt","captain","captain_female","civilian_mariachi","mute_security_undominatable","security_undominatable","escort","escort_criminal","escort_undercover","triad","triad_boss","deep_boss","snowman_boss","biker_escape"}
